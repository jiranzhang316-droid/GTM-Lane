...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['weight_paper'] = '/root/autodl-tmp/RVLD/RVLD-main/TCA-weight/VIL-100'
    ...
    def setting_for_video_processing(self):
        ...
        # -------- Lantca improvements -------- #
        # long-term memory control: 'cat' (original), 'momentum', 'fixed_pool'
        self.lt_memory_mode = 'momentum'
        self.lt_momentum = 0.9
        self.lt_memory_max_len = 50
        # instance-level query-based identity embedding
        self.use_instance_query_id = True
